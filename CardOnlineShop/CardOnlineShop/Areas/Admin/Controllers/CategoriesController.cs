...
namespace CardOnlineShop.Areas.Admin.Controllers
{
    public class CategoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CategoryID,CategoryName,CategoryStatus")] Category category)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CategoryID,CategoryName,CategoryStatus")] Category category)
        {
            if (ModelState.IsValid)
            {
