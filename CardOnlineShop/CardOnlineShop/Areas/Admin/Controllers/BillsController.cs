...
namespace CardOnlineShop.Areas.Admin.Controllers
{
    public class BillsController : Controller
    {
        ...
        {
            var bills = db.Bills.Include(b => b.Employee);
        ...
        public ActionResult Create([Bind(Include = "BillID,CreateDate,EmployeeID")] Bill bill)
        {
            ...
            ViewBag.EmployeeID = new SelectList(db.Employees, "EmployeeID", "EmployeeName", bill.EmployeeID);
            return View(bill);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BillID,CreateDate,EmployeeID")] Bill bill)
        {
            if (ModelState.IsValid)
            {
