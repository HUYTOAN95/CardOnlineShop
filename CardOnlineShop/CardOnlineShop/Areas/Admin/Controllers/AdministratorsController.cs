...
namespace CardOnlineShop.Areas.Admin.Controllers
{
    public class AdministratorsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "UserID,UserName,PassWord,FullName,Email,CreateDate,Avatar,IsAdmin,Allowed")] Administrator administrator)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "UserID,UserName,PassWord,FullName,Email,CreateDate,Avatar,IsAdmin,Allowed")] Administrator administrator)
        {
            if (ModelState.IsValid)
            {
