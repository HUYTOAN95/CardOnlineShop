...
{
    public class ShopOnlineDatabaseInitializer : DropCreateDatabaseIfModelChanges<ShopOnlineDBContext>
    {
        protected override void Seed(ShopOnlineDBContext context)
